...
export default function EditSupplyPage() {
  ...
  const { updateSupply, loading: suppliessLoading } = useSupplies();
  ...
  // Load supply and users on mount
  useEffect(() => {
    loadSupply();
    loadUsers();
  }, [id]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const success = await updateSupply(parseInt(id!), {
        name: formData.name,
      ...
      <div style={{ maxWidth: 600, margin: '0 auto', padding: 20 }}>
        ...
        {success && (
          <div style={{
            ...
            ✅ Supply updated successfully! Redirecting...
          </div>
        )}
